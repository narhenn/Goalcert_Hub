...
// fault, run it against the twin's projection, and score the outcome. Runs on the
// frontend simulator's forward trajectory + zero-token stub authoring/narrative.
...
export default function Scenario() {
  const { active, injectFault } = useTwin()
  const { log } = useAudit()
            ...
            <div>
              ...
              {spec && (
                <div className="card section-gap">
                  <div className="card-title"><Icon n="ti-file-description" /> {spec.title}</div>
            ...
            <div>
              ...
              {result && (
                <>
                  ...
                  <div className="card section-gap">
                    <div className="card-title"><Icon n="ti-report-analytics" /> Outcome
                      <span className="pill pill-purple" style={{ fontSize: 9 }}>scored</span></div>
